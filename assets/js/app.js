...
function renderBoard() {
	...
	var $addListConatiner = document.createElement("div");
	$addListConatiner.className = "list add";
	...
	$addListConatiner.appendChild($addListButton);
	$boardContainer.appendChild($addListConatiner);
}
